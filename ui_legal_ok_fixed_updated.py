...
if edit_index is not None:
    ...
    with st.form("form_edit"):
        ...
        assign_to_options = ["Legal 1", "Legal 2", "Legal 3"]
        assign_to = st.selectbox("Assign ke", assign_to_options, 
                         index=assign_to_options.index(row["Assign To"]) if row["Assign To"] in assign_to_options else 0)
